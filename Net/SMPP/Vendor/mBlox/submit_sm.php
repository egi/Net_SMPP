 ...
 * @link       http://pear.php.net/package/Net_SMPP
 */
class Net_SMPP_Command_Vendor_mBlox_submit_sm extends Net_SMPP_Command_submit_sm {
     ...
     *
     * mBlox has different defaults for different countries; the US defaults to
     * GSM encoding, while Europe defaults to ISO-8859-1. We set it to ISO-8850-1
     * here to avoid things breaking when delivering to different countries.
     *
     * @var  int
     */
    var $data_coding = NET_SMPP_ENCODING_ISO88591;
